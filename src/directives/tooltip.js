  ...
  inserted: function (el, binding, vnode) {
    ...
    if (binding.arg == 'data') {
        ...
        el.onmouseenter = function () {
            ...
            let direction = window.Portal.getTooltipPositionv2(el, tooltipBox);
            ...
            // tooltipBox1.style.top = direction.down.top + 'px';
            // tooltipBox1.style.left = direction.down.left + 'px';
            // tooltipBox1.classList.add(direction.down.class);
        ...
        el.onmouseleave = function () {
            ...
            // document.body.removeChild(tooltipBox1);
            // document.body.removeChild(tooltipBox2);
            // document.body.removeChild(tooltipBox3);
            // document.body.removeChild(tooltipBox4);
        }
  }
})